 ...
 * @author aguare
 */
@WebServlet(name = "ConsultasAdmon", urlPatterns = {"/ConsultasAdmon"})
public class ConsultasAdmon extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("Consultas/Admon/Reportes/VentasFecha.jsp").forward(request, response);
    }
