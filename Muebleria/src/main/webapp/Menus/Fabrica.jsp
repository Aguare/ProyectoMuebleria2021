        ...
        <div class="navbar-nav">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu">					
                    ...
                    <a href="${pageContext.request.contextPath}/Consultas/Fabrica/EditarPieza.jsp?crear=true" class="dropdown-item">Crear Tipo de Pieza</a>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="${pageContext.request.contextPath}/Consultas/Fabrica/MueblesEnsamblados.jsp" class="dropdown-item">Muebles Ensamblados</a>
                </div>
            </div>
