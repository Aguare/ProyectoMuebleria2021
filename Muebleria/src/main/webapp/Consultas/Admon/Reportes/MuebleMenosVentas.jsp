...
<html>
    ...
    <body>
        ...
        <%
            ...
            String fechaInicial = "";
            String fechaFinal = "";           
            ArrayList<String[]> datos = obtener.muebleMasVendido(2);
        ...
        %>
        <div class="container">
            <h1 class="text-center">MUEBLE CON MENOS VENTAS EN UN INTERVALO DE TIEMPO</h1>
            <div class="container border text-center">
                ...
                <form action="${pageContext.request.contextPath}/MuebleMenosVentas" method="POST">
            ...
            <div class="table-responsive-lg table-hover">
                ...
                <table class="table text-center" id="tabla2">
                    <thead>
                        <tr class="thead-dark"><th colspan="5">DETALLES DE VENTAS</th></tr>
        ...
        $(document).ready(function(){
            ...
            $("#botonExportar").on("click", function () {
                ...
                anchorElement.download = "MueblesMenosVendidos.csv";
                anchorElement.click();
